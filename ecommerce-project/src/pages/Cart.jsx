...
function Cart() {
  ...
  return (
    <div className="border-t mb-10 pt-14">
            ...
            >
              <div className="flex items-start gap-6">
                <img
                  ...
                  src={productData.image[0] || "/path/to/default/image.jpg"}
              ...
              <img
                onClick={() => {
                  updateQuantity(item._id, item.size, 0); // Set quantity to 0 to remove the item
                }}
